...
async function test() {
  ...
  const statusesToTest = [
    'pending_payment', 'processing', 'production_pending', 'in_production', 
    'production_done', 'shipping_pending', 'label_generated', 'in_transit', 
    'out_for_delivery', 'approved', 'reserved', 'created', 'paid', 'cancelled', 'refunded', 'delivered', 'shipped'
  ];
