...
> Checkpoint arquitetural. **Não alterar esta tag.** Próximas evoluções em `fase4-cms-storefront`.
...
## Fora desta baseline (branch `fase4-cms-storefront`)

Alterações locais CMS Storefront, ProductForm, inventory — **não incluídas** nesta tag.
